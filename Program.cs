...
//metodo principal de gestion de restaurantes
...
// Método para crear un nuevo restaurante desde consola
...
// Método para editar un restaurante desde consola
...
// Método para borrar un restaurante desde consola
...

{
    ...
    // Método para configurar datos de ejemplo
    ...
    // Método para gestionar menú y clientes
...
// método para gestionar clientes y platos
...
// metodo para despachar el siguiente pedido
...
// Metodo para editar un cliente desde consola
...
// metodo para borrar un cliente desde consola
private static void BorrarClienteDesdeConsola(Restaurante restaurante)
{
    ...
    {
        Console.WriteLine($"\n¡Cliente con cédula '{cedula}' eliminado con éxito!");
    }
    else
    {
...
// metodo para gestionar los platos del menu de un restaurante
...
// metodo que recolecta la informacion para crear un plato desde consola
...

{
    ...
    // Verifica que no exista ya un plato con ese código
...
// metodo para modificar un plato de el menu desde consola
private static void EditarPlatoDesdeConsola(Restaurante restaurante)
{
    ...
    // Llamamos al GestorMenu para aplicar la edición
...
// metodo para eliminar un plato del menu desde la consola
...
// metodo para gestionar los pedidos de un restaurante
...
// Flujo para tomar un nuevo pedido
